         ...
         >
            ...
            >
               <AnimatePresence>
                  {hover === 0 ? (
                     <motion.span
                        ...
                        exit={{ opacity: 0 }}
                        layoutId="hover"
                        className="bg-background pointer-events-none absolute inset-0 -z-10 size-full rounded-[inherit] border"
               ...
               {endWithProperties ? (
                  <motion.span
                     layoutId="selector"
                     className="bg-primary pointer-events-none absolute -bottom-1 left-1/2 z-10 h-0.5 w-3/5 -translate-x-1/2"
